...
**Goal:** 3 版本 A/B 对比，判断份额因子 30% 权重是否最优

**Architecture:** Monkey-patch compute_cp + compute_cp_unified，不改生产代码

**Tech Stack:** Python 3, backtest_unified

---

### Task 1: 编写并运行消融实验脚本

**Files:** Create `scripts/etf_share_ablation.py`
...
```bash
cd D:/airoom/etf-monitor && PYTHONIOENCODING=utf-8 python scripts/etf_share_ablation.py
```

- [ ] **Step 3: 根据结果决定是否修改 W_SHARE**

- [ ] **Step 4: 删除实验脚本 + commit 结果文档**
